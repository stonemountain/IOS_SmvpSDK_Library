...
Pod::Spec.new do |s|
  ...
  s.name         = "player_lib"
  s.version      = "0.0.1"
  s.summary      = "A short description of player_lib."
  ...
  s.homepage     = "https://github.com/stonemountain/PLAYER_LIB"
  ...
  s.source       = { :git => "https://github.com/stonemountain/PLAYER_LIB", :tag => "0.0.1" }
